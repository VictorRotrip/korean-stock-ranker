...
const INDUSTRY_KR_TO_EN: Record<string, string> = {
  ...
  // ---------- 2026-06 gap fill: KSIC sectors still appearing untranslated ----------
  "개인 및 가정용품 수리업": "Personal and Household Goods Repair",
  "교육지원 서비스업": "Educational Support Services",
  "귀금속 및 장신용품 제조업": "Precious Metals and Jewelry Manufacturing",
  "금속 주조업": "Metal Casting",
  "기타 과학기술 서비스업": "Other Scientific and Technical Services",
  "기타 생활용품 소매업": "Other Household Goods Retail",
  "나무제품 제조업": "Wood Products Manufacturing",
  "도시락 및 식사용 조리식품 제조업": "Lunchbox and Prepared Meal Manufacturing",
  "떡, 빵 및 과자류 제조업": "Rice Cake, Bread and Confectionery Manufacturing",
  "마그네틱 및 광학 매체 제조업": "Magnetic and Optical Media Manufacturing",
  "무기 및 총포탄 제조업": "Weapons and Ammunition Manufacturing",
  "사업시설 유지·관리 서비스업": "Facility Maintenance and Management Services",
  "산업용 기계 및 장비 임대업": "Industrial Machinery and Equipment Rental",
  "섬유제품 염색, 정리 및 마무리 가공업": "Textile Dyeing and Finishing",
  "신탁업 및 집합투자업": "Trust and Collective Investment",
  "연료 소매업": "Fuel Retail",
  "운동 및 경기용구 제조업": "Sporting and Athletic Goods Manufacturing",
  "운송장비 임대업": "Transport Equipment Rental",
  "육상 여객 운송업": "Land Passenger Transport",
  "음식점업": "Restaurants",
  "인쇄 및 인쇄관련 산업": "Printing and Related Services",
  "일반 및 생활 숙박시설 운영업": "General and Residential Accommodation",
  "자동차 재제조 부품 제조업": "Remanufactured Auto Parts Manufacturing",
  "전문디자인업": "Specialized Design Services",
  "제재 및 목재 가공업": "Sawmilling and Wood Processing",
  "초등 교육기관": "Primary Education Institutions",
  "편조원단 제조업": "Knitted Fabric Manufacturing",
  "편조의복 제조업": "Knitted Apparel Manufacturing",
  "해체, 선별 및 원료 재생업": "Demolition, Sorting and Material Recovery",
};
